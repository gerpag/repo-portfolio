  ...
  <div id="portfolio-header">
    ...
    <div id="portfolio-header-text-container">
      ...
      <div className="body-text">
        ...
        I have recently trained as a fullstack developer. <a href="https://www.plataforma5.la/bootcamp/javascript" target="_blank" rel="noopener noreferrer">Learn more</a> <br />
        My goal is to continue learning and bridging these fields that I am passionate about.
      </div>
